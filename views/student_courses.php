                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-20">
                                    ...
                                    <div class="p-4 bg-green-100 rounded-xl text-gray-800">
                                        ...
                                        <a href="/student/courses/enrolled" >
                                        ...
                                        <a href="/student/enroll-course">
                                        <button type="button" class="inline-flex items-center justify-center py-2 px-3 mt-3 rounded-xl <?php if (Application::$app->user->getUserCoursesNumber(Application::$app->user->getUserID()) === 6) echo 'bg-red-500'; else echo 'bg-white'; ?> text-gray-800 hover:text-green-500 text-sm font-semibold transition"
                                            <?php if (Application::$app->user->getUserCoursesNumber(Application::$app->user->getUserID()) === 6) echo 'disabled'; ?>>
                                            Enroll
                                        </button>
                                        </a>
                                    </div>
