...
<body class="relative overflow-hidden max-h-screen" style="background-color: #eae9c4;">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="p-4 bg-yellow-100 rounded-xl text-gray-800">
                                    <div class="font-bold text-2xl leading-none"><?php echo Application::$app->user->level_id ?></div>
                                    <div class="mt-2"><?php echo Application::$app->user->getDisplayName()?>'s Level</div>
                                </div>
