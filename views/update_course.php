...
<div class="form-container">
    ...
    <div class="row">
        <div class="col"> Course Code
            <?php
            $selectedCourseCode = null; // Variable to hold the selected course code

            $module = new Module();
            $courses = Application::$app->module->getAllCoursesCodes();

            // Check if the form is submitted and the selected value is available
            if ($module->course_code !== null) {
                $selectedCourseCode = $module->course_code;
            }

            // Render the dropdown input field
            echo '<select name="course_code" class="form-control">';
            foreach ($courses as $course) {
                $selected = ($course === $selectedCourseCode) ? 'selected' : '';
