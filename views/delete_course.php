...
<div class="form-container">
    ...
    <div class="row">
        <div class="col">
            ...
            $module = new Module();
            $courses = Application::$app->module->getAllCoursesNames();
    ...
    <div class="button-container">
        <button type="submit" class="inline-flex items-center justify-center py-2 px-3 rounded-xl bg-white text-gray-800 hover:text-red-500 text-sm font-semibold transition">
            Delete
        </button>
    </div>
